...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 54, 52, 47, 16, 14, 43, 41],
    ...
    isFunctionSubtype: function(s, t) {
      var sBounds, tBounds, sGenericParameters, sReturnType, tReturnType, sParameterTypes, tParameterTypes, sOptionalParameterTypes, tOptionalParameterTypes, sParametersLen, tParametersLen, sOptionalParametersLen, tOptionalParametersLen, t1, t2, pos, t3, t4, tPos, sPos;
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 48, 19],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 14],
    ...
    }, "call$4", "async___rootScheduleMicrotask$closure", 8, 0, 12],
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 49],
    ...
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 50],
    _rootPrint: [function($self, $parent, zone, line) {
      H.printString(H.S(H.stringTypeCheck(line)));
    }, "call$4", "async___rootPrint$closure", 8, 0, 51],
    _printToZone: [function(line) {
      $.Zone__current.print$1(0, line);
    }, "call$1", "async___printToZone$closure", 2, 0, 52],
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 53, 9, 10, 7, 36, 35],
    ...
    HashMap_HashMap$from: function(other, $K, $V) {
      var result = H.assertSubtype(P.HashMap_HashMap(null, null, null, $K, $V), "$isHashMap", [$K, $V], "$asHashMap");
            ...
            if (value >= 0) {
              ...
              if (value === -1) {
                if (firstPadding < 0) {
                  ...
                  if (t3 == null)
                    t3 = 0;
                  firstPadding = H.intTypeCheck(J.$add$ns(t3, i - sliceStart));
    ...
    _Utf8Decoder_convert_addSingleBytes: {
      "^": "Closure:47;$this,codeUnits,startIndex,endIndex",
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 54, 30],
    ...
    _Uri: {
      ...
      static: {
        ...
        _Uri__removeDotSegments: function(path) {
          var t1, output, t2, appendSlash, _i, segment, t3;
          if (!P._Uri__mayContainDotSegments(path))
            return path;
          H.assertHelper(path.length !== 0);
          t1 = P.String;
          output = H.assertSubtype([], "$isList", [t1], "$asList");
          for (t1 = H.setRuntimeTypeInfo(path.split("/"), [t1]), t2 = t1.length, appendSlash = false, _i = 0; _i < t2; ++_i) {
        ...
        _Uri__normalizeRelativePath: function(path, allowScheme) {
          var t1, output, t2, appendSlash, _i, segment;
    ...
    HtmlElement: {
      "^": "Element;",
      $isHtmlElement: 1,
      "%": "HTMLBRElement|HTMLBaseElement|HTMLButtonElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMenuItemElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSlotElement|HTMLSourceElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
    ...
    EventTarget: {
      ...
      $isEventTarget: 1,
      "%": "AnalyserNode|Animation|ApplicationCache|AudioBufferSourceNode|AudioChannelMerger|AudioChannelSplitter|AudioContext|AudioDestinationNode|AudioGainNode|AudioNode|AudioPannerNode|AudioSourceNode|BatteryManager|BiquadFilterNode|BluetoothDevice|BluetoothRemoteGATTCharacteristic|CanvasCaptureMediaStreamTrack|ChannelMergerNode|ChannelSplitterNode|ConvolverNode|CrossOriginServiceWorkerClient|DOMApplicationCache|DelayNode|DynamicsCompressorNode|EventSource|GainNode|IDBDatabase|IIRFilterNode|JavaScriptAudioNode|MIDIAccess|MediaElementAudioSourceNode|MediaKeySession|MediaQueryList|MediaRecorder|MediaSource|MediaStream|MediaStreamAudioDestinationNode|MediaStreamAudioSourceNode|MediaStreamTrack|MessagePort|NetworkInformation|Notification|OfflineAudioContext|OfflineResourceList|Oscillator|OscillatorNode|PannerNode|Performance|PermissionStatus|PresentationAvailability|PresentationReceiver|PresentationRequest|RTCDTMFSender|RTCPeerConnection|RealtimeAnalyserNode|ScreenOrientation|ScriptProcessorNode|ServicePortCollection|ServiceWorkerContainer|ServiceWorkerRegistration|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|StereoPannerNode|USB|WaveShaperNode|WorkerPerformance|mozRTCPeerConnection|webkitAudioContext|webkitAudioPannerNode|webkitRTCPeerConnection;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin1|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0|EventTarget_ListMixin1|EventTarget_ListMixin_ImmutableListMixin"
    },
    File: {
      "^": "Blob;",
      $isObject: 1,
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 55],
    createNgZone: [function() {
      H.assertHelper(true);
      return Y.NgZone$(true);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 56],
    ...
    }, "call$0", "modules__createRandomAppId$closure", 0, 0, 11],
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 3, 13, 27, "call"]
    }
    ...
    NgZone: {
      ...
      }, "call$4", "get$_scheduleMicrotask", 8, 0, 12],
      ...
      _onErrorWithLongStackTrace$2: [function(error, chain) {
        ...
        t4._sendData$1(t3);
      }, "call$2", "get$_onErrorWithLongStackTrace", 4, 0, 31, 2, 40],
    ...
    _RuntimeInjector: {
      ...
      _resolveArgs$2: function(token, deps) {
        ...
        for (i = 0; i < l; ++i) {
          ...
          if (result === C.C_Object)
            return H.assertSubtype(M.throwsNotFound(this, token), "$isList", t1, "$asList");
          resolved[i] = result;
        }
      ...
      }, "useClass$1", "call$2$deps", "call$1", "get$useClass", 2, 3, 33, 0, 42, 23],
      ...
      }, "useFactory$1", "call$2$deps", "call$1", "get$useFactory", 2, 3, 35, 0, 44, 23],
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 0, 0, 2, 45, 46],
      $isFunction: 1,
    ...
    PublicTestability: {
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 39, 0, 0, 20, 49, 50],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 51, 20, 21, "call"]
    },
    ...
    initReflector_closure: {
      "^": "Closure:42;",
      call$2: [function(p0, p1) {
        return N.EventManager$(H.listTypeCheck(p0), H.interceptedTypeCheck(p1, "$isNgZone"));
      }, null, null, 4, 0, null, 3, 13, "call"]
    }
  ...
  }], ["", "package:attribute_directives/app_component.dart",, Q, {
    "^": "",
    AppComponent: {
      "^": "Object;color"
    }
  }], ["", "package:attribute_directives/app_component.template.dart",, V, {
    "^": "",
    ...
    ViewAppComponent0: {
      "^": "AppView;_el_0,_el_2,_el_4,_el_5,_el_7,_el_9,_el_11,_HighlightDirective_11_4,_el_13,_HighlightDirective_13_4,_el_15,_el_16,_el_18,_text_20,_el_21,_el_23,_text_25,_el_26,_el_27,_el_28,_el_30,_HighlightDirective_30_4,_el_32,_HighlightDirective_32_4,_expr_0,_expr_2,_expr_3,_expr_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, t1, doc, _text_6, _text_8, _text_10, _text_17, t2, _text_22, t3;
        ...
        this._el_0 = t1;
        J.append$1$x(t1, doc.createTextNode("My First Attribute Directive"));
        t1 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_2 = t1;
        J.append$1$x(t1, doc.createTextNode("Pick a highlight color"));
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_4 = t1;
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", t1), "$isInputElement");
        this._el_5 = t1;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "name", "colors");
        t1 = this._el_5;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "type", "radio");
        _text_6 = doc.createTextNode("Green");
        t1 = this._el_4;
        (t1 && C.DivElement_methods).append$1(t1, _text_6);
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_4), "$isInputElement");
        this._el_7 = t1;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "name", "colors");
        t1 = this._el_7;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "type", "radio");
        _text_8 = doc.createTextNode("Yellow");
        t1 = this._el_4;
        ...
        t1 = this._el_9;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "type", "radio");
        _text_10 = doc.createTextNode("Cyan");
        t1 = this._el_4;
        (t1 && C.DivElement_methods).append$1(t1, _text_10);
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_11 = t1;
        this._HighlightDirective_11_4 = new K.HighlightDirective(t1, null, null);
        J.append$1$x(t1, doc.createTextNode("Highlight me!"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_13 = t1;
        J.setAttribute$2$x(t1, "defaultColor", "violet");
        t1 = this._el_13;
        this._HighlightDirective_13_4 = new K.HighlightDirective(t1, null, null);
        J.append$1$x(t1, doc.createTextNode("Highlight me too!"));
        this._el_15 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_16 = t1;
        J.setAttribute$2$x(t1, "autoId", "heading-");
        _text_17 = doc.createTextNode("Auto-ID at work");
        J.append$1$x(this._el_16, _text_17);
        t1 = this._el_16;
        t2 = $._idCounter;
        $._idCounter = t2 + 1;
        t1.id = "heading-" + t2;
        t2 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_18 = t2;
        J.append$1$x(t2, doc.createTextNode("The previous heading has ID "));
        t2 = doc.createTextNode("");
        this._text_20 = t2;
        J.append$1$x(this._el_18, t2);
        t2 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_21 = t2;
        J.setAttribute$2$x(t2, "autoId", "heading-");
        _text_22 = doc.createTextNode("Auto-ID at work, again");
        J.append$1$x(this._el_21, _text_22);
        t2 = this._el_21;
        t1 = $._idCounter;
        $._idCounter = t1 + 1;
        t2.id = "heading-" + t1;
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_23 = t1;
        J.append$1$x(t1, doc.createTextNode("The previous heading has ID "));
        t1 = doc.createTextNode("");
        this._text_25 = t1;
        J.append$1$x(this._el_23, t1);
        this._el_26 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_27 = t1;
        t1 = S.createAndAppend(doc, "i", t1);
        this._el_28 = t1;
        J.append$1$x(t1, doc.createTextNode("Mouse over the following lines to see fixed highlights"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_30 = t1;
        this._HighlightDirective_30_4 = new K.HighlightDirective(t1, null, null);
        J.append$1$x(t1, doc.createTextNode("Highlighted in yellow"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_32 = t1;
        J.setAttribute$2$x(t1, "myHighlight", "orange");
        t1 = this._el_32;
        this._HighlightDirective_32_4 = new K.HighlightDirective(t1, null, null);
        J.append$1$x(t1, doc.createTextNode("Highlighted in orange"));
        t1 = this._el_5;
        t2 = this.eventHandler1$1(this.get$_handle_click_5_0());
        t1.toString;
        t3 = {func: 1, args: [W.Event]};
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "click", t2, null);
        t1 = this._el_7;
        t2 = this.eventHandler1$1(this.get$_handle_click_7_0());
        t1.toString;
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "click", t2, null);
        t1 = this._el_9;
        t2 = this.eventHandler1$1(this.get$_handle_click_9_0());
        t1.toString;
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "click", t2, null);
        t1 = this._el_11;
        t2 = this._HighlightDirective_11_4;
        t2 = this.eventHandler0$1(t2.get$onMouseEnter(t2));
        t1.toString;
        H.functionTypeCheck(t2, t3);
        J._addEventListener$3$x(t1, "mouseenter", t2, null);
        t1 = this._el_11;
        t2 = this._HighlightDirective_11_4;
        t2 = this.eventHandler0$1(t2.get$onMouseLeave(t2));
        t1.toString;
        H.functionTypeCheck(t2, t3);
        J._addEventListener$3$x(t1, "mouseleave", t2, null);
        t1 = this._el_13;
        t2 = this._HighlightDirective_13_4;
        t2 = this.eventHandler0$1(t2.get$onMouseEnter(t2));
        t1.toString;
        H.functionTypeCheck(t2, t3);
        J._addEventListener$3$x(t1, "mouseenter", t2, null);
        ...
        J._addEventListener$3$x(t1, "mouseleave", t2, null);
        t1 = this._el_30;
        t2 = this._HighlightDirective_30_4;
        t2 = this.eventHandler0$1(t2.get$onMouseEnter(t2));
        t1.toString;
        H.functionTypeCheck(t2, t3);
        J._addEventListener$3$x(t1, "mouseenter", t2, null);
        ...
        J._addEventListener$3$x(t1, "mouseleave", t2, null);
        t1 = this._el_32;
        t2 = this._HighlightDirective_32_4;
        t2 = this.eventHandler0$1(t2.get$onMouseEnter(t2));
        t1.toString;
        H.functionTypeCheck(t2, t3);
        J._addEventListener$3$x(t1, "mouseenter", t2, null);
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1 = token === C.Type_HighlightDirective_hIj;
        if (t1 && 11 <= nodeIndex && nodeIndex <= 12)
          return this._HighlightDirective_11_4;
        if (t1 && 13 <= nodeIndex && nodeIndex <= 14)
          return this._HighlightDirective_13_4;
        if (t1 && 30 <= nodeIndex && nodeIndex <= 31)
          return this._HighlightDirective_30_4;
        if (t1 && 32 <= nodeIndex && nodeIndex <= 33)
          return this._HighlightDirective_32_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, local_h1, local_h2, currVal_0, t1, currVal_3, currVal_4;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        local_h1 = this._el_16;
        local_h2 = this._el_21;
        currVal_0 = _ctx.color;
        t1 = this._expr_0;
        if (t1 == null ? currVal_0 != null : t1 !== currVal_0) {
          this._HighlightDirective_11_4.highlightColor = currVal_0;
          this._expr_0 = currVal_0;
        }
        if (firstCheck)
          this._HighlightDirective_13_4.defaultColor = "violet";
        t1 = this._expr_2;
        if (t1 == null ? currVal_0 != null : t1 !== currVal_0) {
          this._HighlightDirective_13_4.highlightColor = currVal_0;
          this._expr_2 = currVal_0;
        }
        if (firstCheck)
          this._HighlightDirective_30_4.highlightColor = "yellow";
        if (firstCheck)
          this._HighlightDirective_32_4.highlightColor = "orange";
        currVal_3 = Q.interpolate0(local_h1.id);
        if (this._expr_3 !== currVal_3) {
          this._text_20.textContent = currVal_3;
          this._expr_3 = currVal_3;
        }
        currVal_4 = Q.interpolate0(local_h2.id);
        if (this._expr_4 !== currVal_4) {
          this._text_25.textContent = currVal_4;
          this._expr_4 = currVal_4;
        }
      },
      _handle_click_5_0$1: [function($$event) {
        this.ctx.color = "lightgreen";
      }, "call$1", "get$_handle_click_5_0", 2, 0, 6],
      _handle_click_7_0$1: [function($$event) {
        this.ctx.color = "yellow";
      }, "call$1", "get$_handle_click_7_0", 2, 0, 6],
      _handle_click_9_0$1: [function($$event) {
        this.ctx.color = "cyan";
      }, "call$1", "get$_handle_click_9_0", 2, 0, 6],
      $asAppView: function() {
    ...
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3, t4;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), this, null, null, null);
  ...
  }], ["", "package:attribute_directives/src/auto_id_directive.template.dart",, F, {
    "^": "",
  ...
  }], ["", "package:attribute_directives/src/highlight_directive.dart",, K, {
    "^": "",
    HighlightDirective: {
      "^": "Object;_el,defaultColor,highlightColor",
      onMouseEnter$0: [function(_) {
        var t1, t2;
        t1 = this.highlightColor;
        if (t1 == null)
          t1 = this.defaultColor;
        if (t1 == null)
          t1 = "red";
        t2 = this._el.style;
        t2.backgroundColor = t1;
        return;
      }, "call$0", "get$onMouseEnter", 0, 0, 2],
      onMouseLeave$0: [function(_) {
        var t1 = this._el.style;
        t1.backgroundColor = "";
        return;
      }, "call$0", "get$onMouseLeave", 0, 0, 2]
    }
  }], ["", "package:attribute_directives/src/highlight_directive.template.dart",, K, {
    "^": "",
    ...
    Frame: {
      ...
      get$$package: function() {
        ...
        if (t1.get$scheme() !== "package")
          return;
        return H.stringTypeCheck(C.JSArray_methods.get$first(H.setRuntimeTypeInfo(t1.get$path(t1).split("/"), [P.String])));
      },
      get$location: function(_) {
        var t1, t2;
        t1 = this.line;
    ...
    closure2: {
      ...
      call$0: function() {
        ...
        if (3 >= t1.length)
          return H.ioore(t1, 3);
        lineAndColumn = H.setRuntimeTypeInfo(H.stringTypeCheck(t1[3]).split(":"), [P.String]);
    ...
    StackZoneSpecification: {
      ...
      }, "call$5", "get$_stack_zone_specification$_handleUncaughtError", 10, 0, 13],
      ...
      }, "call$5", "get$_stack_zone_specification$_errorCallback", 10, 0, 14],
  ...
  }], ["", "package:attribute_directives/src/auto_id_directive.dart",, B, {
    "^": ""
  }]];
...
;
  ...
  C.Type_HighlightDirective_hIj = H.createRuntimeType("HighlightDirective");
  ...
  $ = new Isolate();
  init.metadata = [null, "_", "error", "p0", "line", "frame", "trace", "zone", "stackTrace", "self", "parent", "arg", "result", "p1", "arg2", "callback", "arg1", "invocation", "f", "value", "elem", "findInAncestors", "x", "deps", "t", "event", "e", "p2", "errorCode", "element", "encodedComponent", "s", "o", "ref", "err", "zoneValues", "specification", "arguments", "each", "fn", "chain", "arg4", "clazz", "arg3", "factory", "stack", "reason", "numberOfArguments", "theStackTrace", "binding", "exactMatch", true, "isolate", "didWork_", "closure", "sender", "object", "theError"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, args: [P.String,,]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, args: [P.int,,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Future}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, v: true, args: [P.Function]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [P.List, Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, ret: P.bool}];
