...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 37, 25, 52, 12, 18, 47, 40],
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 39, 15],
    _nullErrorHandler: [function(error, stackTrace) {
      $.Zone__current.handleUncaughtError$2(error, stackTrace);
    }, function(error) {
      return P._nullErrorHandler(error, null);
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 6, 3, 4, 7],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 40],
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 41],
    _rootCreatePeriodicTimer: [function($self, $parent, zone, duration, callback) {
      return P.Timer__createPeriodicTimer(duration, C.C__RootZone !== zone ? zone.bindUnaryCallback$1(callback) : callback);
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 42],
    _rootPrint: [function($self, $parent, zone, line) {
      H.printString(H.S(line));
    }, "call$4", "async___rootPrint$closure", 8, 0, 43],
    _printToZone: [function(line) {
      J.print$1$x($.Zone__current, line);
    }, "call$1", "async___printToZone$closure", 2, 0, 44],
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 45, 1, 0, 2, 30, 27],
    ...
    _awaitOnObject_closure0: {
      ...
      }, null, null, 4, 0, null, 4, 7, "call"]
    },
    _wrapJsFunctionForAsync_closure: {
      "^": "Closure:16;$protected",
      call$2: [function(errorCode, result) {
        this.$protected(errorCode, result);
      }, null, null, 4, 0, null, 26, 11, "call"]
    },
    _BroadcastStream: {
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 6]
    },
    _AsyncCompleter: {
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 6, 3, 4, 7],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 3, 4, 7, "call"]
    },
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 38, 4, 7],
    ...
    CssStyleDeclarationBase: {
      "^": "Object;",
      get$color: function(receiver) {
        var propValue = receiver.getPropertyValue(this._browserPropertyName$1(receiver, "color"));
    ...
    DomIterator: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 13],
      "%": "Iterator"
    },
    DomRectReadOnly: {
      "^": "Interceptor;",
    ...
    Cursor: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 18],
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 46],
    createNgZone: [function() {
      return Y.NgZone$(false);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 47],
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 6, 9, 20, "call"]
    }
    ...
    ComponentFactory: {
      ...
      create$2: function(injector, projectableNodes) {
        ...
        return hostView.createHostView$2(injector, projectableNodes);
      }
    }
    ...
    NgZone: {
      ...
      }, "call$4", "get$_ng_zone$_scheduleMicrotask", 8, 0, 11, 1, 0, 2, 8],
      ...
      }, "call$5", "get$_onErrorWithoutLongStackTrace", 10, 0, 12, 1, 0, 2, 4, 41],
      ...
      }, "call$5", "get$_createTimer", 10, 0, 28, 1, 0, 2, 42, 8],
    ...
    _RuntimeInjector: {
      ...
      useClass$2$deps: [function(clazz, deps) {
        ...
        return t1;
      }, null, "get$useClass", 2, 3, null, 3, 43, 44]
    },
    _FlatProviders: {
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 3, 3, 4, 45, 46]
    }
    ...
    PublicTestability: {
      ...
      }, "call$0", "get$isStable", 0, 0, 30],
      whenStable$1: [function(callback) {
        this._testability.whenStable$1(callback);
      }, "call$1", "get$whenStable", 2, 0, 4, 14],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 31, 3, 3, 13, 49, 50],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 51, 13, 22, "call"]
    },
    ...
    viewFactory_AppComponentHost0: [function(parentView, parentIndex) {
      ...
      return t1;
    }, "call$2", "app_component_template__viewFactory_AppComponentHost0$closure", 4, 0, 32],
    ...
    ViewAppComponent0: {
      "^": "AppView;_el_0,_el_2,_el_4,_el_5,_el_7,_el_9,_el_11,_HighlightDirective_11_4,_el_13,_HighlightDirective_13_4,_el_15,_el_16,_el_18,_text_19,_el_20,_el_22,_text_23,_el_24,_el_25,_el_26,_el_28,_HighlightDirective_28_4,_el_30,_HighlightDirective_30_4,_expr_0,_expr_2,_expr_3,_expr_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, doc, t1, _text_6, _text_8, _text_10, _text_17, t2, _text_21;
        parentRenderNode = this.rootEl;
        if (this.componentType._hostAttr != null)
          J.get$classes$x(parentRenderNode).add$1(0, this.componentType._hostAttr);
        doc = document;
        t1 = S.createAndAppend(doc, "h1", parentRenderNode);
        this._el_0 = t1;
        t1.appendChild(doc.createTextNode("My First Attribute Directive"));
        t1 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_2 = t1;
        t1.appendChild(doc.createTextNode("Pick a highlight color"));
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_4 = t1;
        t1 = S.createAndAppend(doc, "input", t1);
        this._el_5 = t1;
        J.setAttribute$2$x(t1, "name", "colors");
        J.setAttribute$2$x(this._el_5, "type", "radio");
        _text_6 = doc.createTextNode("Green");
        this._el_4.appendChild(_text_6);
        t1 = S.createAndAppend(doc, "input", this._el_4);
        this._el_7 = t1;
        J.setAttribute$2$x(t1, "name", "colors");
        J.setAttribute$2$x(this._el_7, "type", "radio");
        _text_8 = doc.createTextNode("Yellow");
        this._el_4.appendChild(_text_8);
        t1 = S.createAndAppend(doc, "input", this._el_4);
        this._el_9 = t1;
        J.setAttribute$2$x(t1, "name", "colors");
        J.setAttribute$2$x(this._el_9, "type", "radio");
        ...
        this._el_20 = t1;
        J.setAttribute$2$x(t1, "autoId", "heading-");
        _text_21 = doc.createTextNode("Auto-ID at work, again");
        ...
        this._text_23 = t1;
        t2.appendChild(t1);
        this._el_24 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_25 = t1;
        t1 = S.createAndAppend(doc, "i", t1);
        this._el_26 = t1;
        t1.appendChild(doc.createTextNode("Mouse over the following lines to see fixed highlights"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_28 = t1;
        this._HighlightDirective_28_4 = new K.HighlightDirective(t1, null, null);
        t1.appendChild(doc.createTextNode("Highlighted in yellow"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_30 = t1;
        J.setAttribute$2$x(t1, "myHighlight", "orange");
        t1 = this._el_30;
        this._HighlightDirective_30_4 = new K.HighlightDirective(t1, null, null);
        t1.appendChild(doc.createTextNode("Highlighted in orange"));
        J._addEventListener$3$x(this._el_5, "click", this.eventHandler1$1(this.get$_handle_click_5_0()), null);
        J._addEventListener$3$x(this._el_7, "click", this.eventHandler1$1(this.get$_handle_click_7_0()), null);
        J._addEventListener$3$x(this._el_9, "click", this.eventHandler1$1(this.get$_handle_click_9_0()), null);
        t1 = this._el_11;
        t2 = this._HighlightDirective_11_4;
        J._addEventListener$3$x(t1, "mouseenter", this.eventHandler0$1(t2.get$onMouseEnter(t2)), null);
        t1 = this._el_11;
        t2 = this._HighlightDirective_11_4;
        J._addEventListener$3$x(t1, "mouseleave", this.eventHandler0$1(t2.get$onMouseLeave(t2)), null);
        t1 = this._el_13;
        ...
        J._addEventListener$3$x(t1, "mouseleave", this.eventHandler0$1(t2.get$onMouseLeave(t2)), null);
        t1 = this._el_28;
        t2 = this._HighlightDirective_28_4;
        J._addEventListener$3$x(t1, "mouseenter", this.eventHandler0$1(t2.get$onMouseEnter(t2)), null);
        t1 = this._el_28;
        t2 = this._HighlightDirective_28_4;
        J._addEventListener$3$x(t1, "mouseleave", this.eventHandler0$1(t2.get$onMouseLeave(t2)), null);
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        ...
        if (t1 && 28 <= nodeIndex && nodeIndex <= 29)
          return this._HighlightDirective_28_4;
        if (t1 && 30 <= nodeIndex && nodeIndex <= 31)
          return this._HighlightDirective_30_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, local_h1, local_h2, t1, currVal_0, t2, currVal_2, currVal_3, currVal_4;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        local_h1 = this._el_16;
        local_h2 = this._el_20;
        t1 = J.getInterceptor$x(_ctx);
        currVal_0 = t1.get$color(_ctx);
        t2 = this._expr_0;
        ...
        currVal_2 = t1.get$color(_ctx);
        t1 = this._expr_2;
        if (t1 == null ? currVal_2 != null : t1 !== currVal_2) {
          this._HighlightDirective_13_4.highlightColor = currVal_2;
          this._expr_2 = currVal_2;
        }
        if (firstCheck)
          this._HighlightDirective_28_4.highlightColor = "yellow";
        if (firstCheck)
          this._HighlightDirective_30_4.highlightColor = "orange";
        t1 = J.get$id$x(local_h1);
        currVal_3 = "The previous heading has ID " + (t1 == null ? "" : t1);
        if (this._expr_3 !== currVal_3) {
          this._text_19.textContent = currVal_3;
          this._expr_3 = currVal_3;
        }
        t1 = J.get$id$x(local_h2);
        currVal_4 = "The previous heading has ID " + (t1 == null ? "" : t1);
        if (this._expr_4 !== currVal_4) {
          this._text_23.textContent = currVal_4;
          this._expr_4 = currVal_4;
        }
      },
      _handle_click_5_0$1: [function($$event) {
        J.set$color$x(this.ctx, "lightgreen");
      }, "call$1", "get$_handle_click_5_0", 2, 0, 7],
      _handle_click_7_0$1: [function($$event) {
        J.set$color$x(this.ctx, "yellow");
      }, "call$1", "get$_handle_click_7_0", 2, 0, 7],
      _handle_click_9_0$1: [function($$event) {
        J.set$color$x(this.ctx, "cyan");
      }, "call$1", "get$_handle_click_9_0", 2, 0, 7]
    },
    _ViewAppComponentHost0: {
      "^": "AppView;_compView_0,_AppComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), this, null, null, null);
...
;
  ...
  }, "CssClassSetImpl__validTokenRE", "COMPONENT_REGEX", "$get$COMPONENT_REGEX", function() {
  ...
  $ = new Isolate();
  init.metadata = ["parent", "self", "zone", null, "error", "_", "p0", "stackTrace", "fn", "p1", "arg", "result", "arg1", "elem", "callback", "value", "invocation", "f", "arg2", "event", "p2", "e", "findInAncestors", "x", "data", "isolate", "errorCode", "zoneValues", "theStackTrace", "element", "specification", "k", "v", "o", "ref", "err", "arguments", "closure", "sender", "each", "arg4", "trace", "duration", "clazz", "deps", "stack", "reason", "arg3", "object", "binding", "exactMatch", true, "numberOfArguments", "didWork_", "t", "theError"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.Function]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [P.int,,]}, {func: 1, ret: [P.List, W.RtcStatsReport]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Future}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [P.String]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, args: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [P.List, Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, args: [W.Element], opt: [P.bool]}];
