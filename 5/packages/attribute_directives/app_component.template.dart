...
class ViewAppComponent0 extends AppView<import1.AppComponent> {
  ...
  import3.HighlightDirective _HighlightDirective_11_5;
  import2.Element _el_13;
  import3.HighlightDirective _HighlightDirective_13_5;
  ...
  import3.HighlightDirective _HighlightDirective_30_5;
  import2.Element _el_32;
  import3.HighlightDirective _HighlightDirective_32_5;
  String _expr_0;
  String _expr_2;
  var _expr_3;
  var _expr_4;
  ...
  ComponentRef<import1.AppComponent> build() {
    ...
    _HighlightDirective_11_5 = new import3.HighlightDirective(_el_11);
    ...
    _HighlightDirective_13_5 = new import3.HighlightDirective(_el_13);
    ...
    _HighlightDirective_30_5 = new import3.HighlightDirective(_el_30);
    ...
    _HighlightDirective_32_5 = new import3.HighlightDirective(_el_32);
    ...
    _el_11.addEventListener('mouseenter', eventHandler0(_HighlightDirective_11_5.onMouseEnter));
    _el_11.addEventListener('mouseleave', eventHandler0(_HighlightDirective_11_5.onMouseLeave));
    _el_13.addEventListener('mouseenter', eventHandler0(_HighlightDirective_13_5.onMouseEnter));
    _el_13.addEventListener('mouseleave', eventHandler0(_HighlightDirective_13_5.onMouseLeave));
    _el_30.addEventListener('mouseenter', eventHandler0(_HighlightDirective_30_5.onMouseEnter));
    _el_30.addEventListener('mouseleave', eventHandler0(_HighlightDirective_30_5.onMouseLeave));
    _el_32.addEventListener('mouseenter', eventHandler0(_HighlightDirective_32_5.onMouseEnter));
    _el_32.addEventListener('mouseleave', eventHandler0(_HighlightDirective_32_5.onMouseLeave));
    init(const [], null);
    return null;
  }
  ...
  void detectChangesInternal() {
    ...
    if (!identical(_expr_0, currVal_0)) {
      _HighlightDirective_11_5.highlightColor = currVal_0;
      _expr_0 = currVal_0;
    }
    if (firstCheck) {
      (_HighlightDirective_13_5.defaultColor = 'violet');
    }
    final currVal_2 = _ctx.color;
    if (!identical(_expr_2, currVal_2)) {
      _HighlightDirective_13_5.highlightColor = currVal_2;
      _expr_2 = currVal_2;
    }
    if (firstCheck) {
      (_HighlightDirective_30_5.highlightColor = 'yellow');
    }
    if (firstCheck) {
      (_HighlightDirective_32_5.highlightColor = 'orange');
    }
